  ...
  return (
    <div className="Info">
      <div className="part">
        <div className="field">
          <p>
            Napchart is a time planning tool that helps you visualize time
        ...
        <div className="field">
          <p>
            <strong>Create element:</strong> Click on an empty space on the
            chart and drag
          </p>
        </div>
        <div className="field">
          <p>
            <strong>Delete element:</strong> Set duration to zero or press{" "}
        ...
        <div className="control">
          <label className="radio">
            <input
              type="radio"
              name="answer"
              onChange={changeAmpm.bind(null, true)}
              checked={ampm}
            />
            <span> AM/PM</span>
          </label>
          <label className="radio">
            <input
              type="radio"
              name="answer"
              onChange={changeAmpm.bind(null, false)}
              checked={!ampm}
            />
            <span> 24 hours</span>
          </label>
