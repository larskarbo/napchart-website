...
export const PremiumModal = ({ exit }) => {
  ...
  return (
    <div
      onClick={exit}
      className="py-12 bg-black bg-opacity-70 absolute top-0 left-0 right-0 bottom-0 z-20 flex center"
    >
      <div className="flex h-full w-full max-w-5xl p-4 bg-white shadow-xl rounded-lg">
